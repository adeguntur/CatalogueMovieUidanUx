...
package g.ade.cataloguemovieuidanux;
...
import g.ade.cataloguemovieuidanux.api.APIClient;
import g.ade.cataloguemovieuidanux.database.FavoriteHelper;
import g.ade.cataloguemovieuidanux.model.ResultsItem;
import g.ade.cataloguemovieuidanux.model.detail.DetailModel;
import g.ade.cataloguemovieuidanux.provider.FavoriteColumns;
import g.ade.cataloguemovieuidanux.util.DateTime;
import g.ade.cataloguemovieuidanux.util.Language;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

import static g.ade.cataloguemovieuidanux.provider.DatabaseContract.CONTENT_URI;
